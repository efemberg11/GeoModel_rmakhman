...
// in Geant4-11.0. More exactly, a version that can be utilised on the top of
...
#ifndef GammaGeneralProcess_h
#define GammaGeneralProcess_h 1
...
class GammaGeneralProcess : public G4VEmProcess
{
public:

  explicit GammaGeneralProcess(const G4String& pname="local-GammaGeneralProc");

  ~GammaGeneralProcess() override;
...
public:
  ...
  // implementation of virtual method, specific for GammaGeneralProcess
  ...
  GammaGeneralProcess(GammaGeneralProcess &) = delete;
  GammaGeneralProcess & operator=
  (const GammaGeneralProcess &right) = delete;
...
inline G4double
GammaGeneralProcess::ComputeGeneralLambda(size_t idxe, size_t idxt)
{
  idxEnergy = idxe;
...
inline G4double GammaGeneralProcess::GetProbability(size_t idxt)
{
...
inline void
GammaGeneralProcess::SelectedProcess(const G4Step& step, G4VProcess* ptr)
{
  selectedProc = ptr;
...
inline void GammaGeneralProcess::SelectEmProcess(const G4Step& step, G4VEmProcess* proc)
{
...
inline const G4VProcess* GammaGeneralProcess::GetSelectedProcess() const
{
  return selectedProc;
}
