...
EmExtraPhysics::EmExtraPhysics(G4int ver):
  G4VPhysicsConstructor("GammaLeptoNuclearPhys"),
  gnActivated (true),
  eActivated  (true),
  ...
  verbose(ver)
{
  ...
  if(verbose > 1) G4cout << "### EmExtraPhysics" << G4endl;
}

EmExtraPhysics::EmExtraPhysics(const G4String&)
  : EmExtraPhysics(1)
{}

EmExtraPhysics::~EmExtraPhysics()
{}


void EmExtraPhysics::Synch(G4bool val)
{
  synActivated = val;
}

void EmExtraPhysics::SynchAll(G4bool val)
{
  synActivatedForAll = val;
  if(synActivatedForAll) { synActivated = true; }
}

void EmExtraPhysics::GammaNuclear(G4bool val)
{
  gnActivated = val;
}

void EmExtraPhysics::LENDGammaNuclear(G4bool val)
{
  gLENDActivated = val;
}

void EmExtraPhysics::ElectroNuclear(G4bool val)
{
  eActivated = val;
}

void EmExtraPhysics::MuonNuclear(G4bool val)
{
  munActivated = val;
}

void EmExtraPhysics::GammaToMuMu(G4bool val)
{
  gmumuActivated = val;
}

void EmExtraPhysics::PositronToMuMu(G4bool val)
{
  pmumuActivated = val;
}

void EmExtraPhysics::PositronToHadrons(G4bool val)
{
  phadActivated = val;
}

void EmExtraPhysics::GammaToMuMuFactor(G4double val)
{
  if(val > 0.0) gmumuFactor = val;
}

void EmExtraPhysics::PositronToMuMuFactor(G4double val)
{
  if(val > 0.0) pmumuFactor = val;
}

void EmExtraPhysics::PositronToHadronsFactor(G4double val)
{
...
void EmExtraPhysics::NeutrinoActivated(G4bool val)
{
  fNuActivated = val;
}

void EmExtraPhysics::NuETotXscActivated(G4bool val)
{
  fNuETotXscActivated = val;
}

void EmExtraPhysics::SetNuEleCcBias(G4double bf)
{
  if(bf > 0.0) fNuEleCcBias = bf;
}

void EmExtraPhysics::SetNuEleNcBias(G4double bf)
{
  if(bf > 0.0) fNuEleNcBias = bf;
}

void EmExtraPhysics::SetNuNucleusBias(G4double bf)
{
  if(bf > 0.0) fNuNucleusBias = bf;
}

void EmExtraPhysics::SetNuDetectorName(const G4String& dn)
{
  fNuDetectorName = dn;
}
...
void EmExtraPhysics::ConstructParticle()
{
  G4Gamma::Gamma();
  G4Electron::Electron();
  G4Positron::Positron();
...
void EmExtraPhysics::ConstructProcess()
{
  ...
  if(gmumuActivated) {
    ...
    GammaGeneralProcess* sp =
      (GammaGeneralProcess*)emManager->GetGammaGeneralProcess();
    if(sp) {
...
void EmExtraPhysics::ConstructGammaElectroNuclear()
{
  G4LossTableManager* emManager  = G4LossTableManager::Instance();
  G4PhysicsListHelper* ph = G4PhysicsListHelper::GetPhysicsListHelper();
...
void EmExtraPhysics::ConstructLENDGammaNuclear(
     G4CascadeInterface* cascade, G4PhotoNuclearProcess* gnuc)
{
  if (std::getenv("G4LENDDATA") == nullptr ) {
    ...
    G4Exception( "EmExtraPhysics::ConstructLENDGammaNuclear()"
...
//
G4_DECLARE_PHYSCONSTR_FACTORY(EmExtraPhysics);
...
void EmExtraPhysics::SetUseGammaNuclearXS(G4bool val)
{
...
void EmExtraPhysics::GammaNuclearLEModelLimit(G4double val)
{
  if(val <= CLHEP::MeV) {
...
void EmExtraPhysics::ConstructGammaElectroNuclear()
{
  ...
  if(eActivated) {
    ...
    GammaGeneralProcess* eproc =
      (GammaGeneralProcess*)emManager->GetElectronGeneralProcess();
    if(eproc != nullptr) {
    ...
    GammaGeneralProcess* pproc =
      (GammaGeneralProcess*)emManager->GetPositronGeneralProcess();
    if(pproc != nullptr) {
