...
#include <map>
//TO DO dependecies from fROOT :D
//#include "TRandom3.h"
//#include "TF1.h"
//#include "TNtupleD.h"
//#include "TFile.h"
...
//#else
    double result = 1; //TO DO m_f_vol->Integral(m_Rmin, m_Rmax, IntPrecision)
//#endif
...
{
    return 1 ; //TO DO m_f_area_on_pc->Integral(m_Zmin, m_Zmax);
}
...
{
  //TO DO  m_f_length->SetParameter(0, r);
...
//#else
    return 1; //TO DO m_f_side_area->Integral(m_Rmin, m_Rmax, IntPrecision);
//#endif
}
...
{
  //TO DO m_f_area->SetParameter(0, r);
  ...
  zmax = m_Zmax - zmax;
    ...
    double result = 1; //TO DO m_f_area->Integral(zmin, zmax);
