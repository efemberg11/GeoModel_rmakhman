...
#define cm3 SYSTEM_OF_UNITS::cm3
    ...
    GeoFullPhysVol* world = new GeoFullPhysVol(worldLog);
    ...
    std::cout << "\nTest - list of all the GeoMaterial nodes in the "
                 "persistified geometry:"
              << std::endl;
    db.printAllMaterials();
    std::cout << "\nTest - list of all the GeoElement nodes in the "
                 "persistified geometry:"
              << std::endl;
    db.printAllElements();
