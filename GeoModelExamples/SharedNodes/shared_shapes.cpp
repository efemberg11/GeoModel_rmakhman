...
/*
 * This example tests shared shapes.
 *
 * It creates one single GeoShape.
 * Then it creates two LogVol nodes using the same GeoShape.
 * Then it creates two PhysVol volumes using the two above LogVols.
 *
...
#define cm3 SYSTEM_OF_UNITS::cm3
    ...
    const GeoLogVol *t2Log = new GeoLogVol("T2Log", t1Tube, Iron);
    ...
    GeoTransform *xf1 = new GeoTransform(GeoTrf::Translate3D(-10.0, 0, 0));
