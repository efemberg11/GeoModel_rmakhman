#!/bin/bash
#
# This script fetches code from the main ATLAS repositories.  It is a
# simple way of syncing the emec special shape code to those repositories.
# The intention is that it be run periodically to fetch any updates. 
#
...
git remote add -f origin ssh://git@gitlab.cern.ch:7999/boudreau/athena.git
git pull origin LAR-PORTABLE-SHAPE-PART2
rm -rf EMECLib/.git
