...
class LArWheelCalculator
{
  ...
  public:
    ...
    LArWheelCalculator(LArG4::LArWheelCalculator_t a_wheelType
  ...
  private:
    ...
    void outer_wheel_init(const LArWheelCalculatorParameters& parameters);
    void inner_wheel_init(const LArWheelCalculatorParameters& parameters);
    void module_init();
