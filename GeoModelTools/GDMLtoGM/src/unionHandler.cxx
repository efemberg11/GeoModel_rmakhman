...
unionHandler::unionHandler(std::string n, GDMLController* c): GDMLHandler(n,c) 
{
}
void unionHandler::ElementHandle() 
{
	...
	GeoShapeUnion* unionSolid=new GeoShapeUnion(firstSolid,secondSolid);
	theController->saveSolid(name,unionSolid);
