...
//const int  G4VTwistSurface::sOutside        = 0x00000000;
//const int  G4VTwistSurface::sInside         = 0x10000000;
//const int  G4VTwistSurface::sBoundary       = 0x20000000;
//const int  G4VTwistSurface::sCorner         = 0x40000000;
//const int  G4VTwistSurface::sC0Min1Min      = 0x40000101;
//const int  G4VTwistSurface::sC0Max1Min      = 0x40000201;
//const int  G4VTwistSurface::sC0Max1Max      = 0x40000202;
//const int  G4VTwistSurface::sC0Min1Max      = 0x40000102;
//const int  G4VTwistSurface::sAxisMin        = 0x00000101;
//const int  G4VTwistSurface::sAxisMax        = 0x00000202;
//const int  G4VTwistSurface::sAxisX          = 0x00000404;
//const int  G4VTwistSurface::sAxisY          = 0x00000808;
//const int  G4VTwistSurface::sAxisZ          = 0x00000C0C;
//const int  G4VTwistSurface::sAxisRho        = 0x00001010;
//const int  G4VTwistSurface::sAxisPhi        = 0x00001414;
//
//// mask
//const int  G4VTwistSurface::sAxis0          = 0x0000FF00;
//const int  G4VTwistSurface::sAxis1          = 0x000000FF;
//const int  G4VTwistSurface::sSizeMask       = 0x00000303;
//const int  G4VTwistSurface::sAxisMask       = 0x0000FCFC;
//const int  G4VTwistSurface::sAreaMask       = 0XF0000000;
...
//SbTwistSurface::SbTwistSurface( __void__& )
...
////* AmIOnLeftSide -----------------------------------------------------
//
//int G4VTwistSurface::AmIOnLeftSide(const G4ThreeVector& me,
...
////* DistanceToBoundary ------------------------------------------------
//
//G4double G4VTwistSurface::DistanceToBoundary(int areacode,
//                                             G4ThreeVector& xx,
...
//   int         areacode[G4VSURFACENXX]  ;
//   G4bool        isvalid[G4VSURFACENXX]   ;
//   
//   for (int i = 0 ; i<G4VSURFACENXX ; ++i )
//   {
...
//
//   int         nxx = DistanceToSurface(gp, gv, gxx, distance, areacode,
...
//         int       nneighbours   = GetNeighbours(areacode[i], neighbours);
//            
...
//            int         tmpareacode[G4VSURFACENXX] ;
//            G4bool        tmpisvalid[G4VSURFACENXX] ;
//
//            for (int l = 0 ; l<G4VSURFACENXX ; ++l )
//            {
//              tmpdist[l] = kInfinity ;
...
//
//G4bool
//G4VTwistSurface::IsSameBoundary(G4VTwistSurface* surf1, int areacode1,
//                                G4VTwistSurface* surf2, int areacode2 ) const
//{
//   //
//   // IsSameBoundary
//   //
...
//
//void G4VTwistSurface::GetBoundaryParameters(const int& areacode,
//                                             G4ThreeVector& d,
//                                             G4ThreeVector& x0,
...
////* GetBoundaryAtPZ ---------------------------------------------------
//
//G4ThreeVector G4VTwistSurface::GetBoundaryAtPZ(int areacode,
...
////* SetCorner ---------------------------------------------------------
//
//void G4VTwistSurface::SetCorner(int areacode,
...
////* SetBoundaryAxis ---------------------------------------------------
//
//void G4VTwistSurface::GetBoundaryAxis(int areacode, EAxis axis[]) const
//{
...
//      int axiscode = whichaxis & sAxisMask & areacode ;
//      if (axiscode) {
...
////* SetBoundaryLimit --------------------------------------------------
//
//void G4VTwistSurface::GetBoundaryLimit(int areacode, G4double limit[]) const
//{
//   if (areacode & sCorner) {
...
////* SetBoundary -------------------------------------------------------
//
//void G4VTwistSurface::SetBoundary(const int& axiscode,
//                                  const G4ThreeVector& direction,
//                                  const G4ThreeVector& x0,
//                                  const int& boundarytype)
//{
//   int code = (~sAxisMask) & axiscode;
...
////* GetFace -----------------------------------------------------------
//
//int G4VTwistSurface::GetFace( int i, int j, int k,
//                                int n, int iside )
//{
//  // this is the face mapping function
//  // (i,j) -> face number
...
////* GetNode -----------------------------------------------------------
//
//int G4VTwistSurface::GetNode( int i, int j, int k,
//                                int n, int iside )
//{
//  // this is the node mapping function
//  // (i,j) -> node number
...
////* GetEdgeVisiblility ------------------------------------------------
//
//int G4VTwistSurface::GetEdgeVisibility( int i, int j, int k, int n,
//                                          int number, int orientation )
//{
//  // clockwise filling         -> positive orientation
//  // counter clockwise filling -> negative orientation
...
//
//void
//G4VTwistSurface::CurrentStatus::SetCurrentStatus(int i,
//                                                 G4ThreeVector& xx,
//                                                 G4double& dist,
//                                                 int& areacode,
//                                                 G4bool& isvalid,
...
//
//void
//G4VTwistSurface::Boundary::SetFields(const int& areacode,
...
//
//G4bool
//G4VTwistSurface::Boundary::GetBoundaryParameters(const int& areacode,
//                                                  G4ThreeVector& d,
//                                                  G4ThreeVector& x0,
//                                                  int& boundarytype) const
//{
