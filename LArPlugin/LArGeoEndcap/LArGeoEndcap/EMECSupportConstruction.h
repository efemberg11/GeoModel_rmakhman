...
class EMECSupportConstruction
{
 public:
  ...
  EMECSupportConstruction(LArGeoMaterialManager* matman
			  , type_t type
			  , bool pos_zside = true
 ...
 private:
  ...
  GeoInpRecordset_ptr m_DB_EmecGeometry; 
  GeoInpRecordset_ptr m_DB_EmecWheelParameters; 
  GeoInpRecordset_ptr m_DB_mn;
  GeoInpRecordset_ptr m_DB_boxes; 
  GeoInpRecordset_ptr m_DB_numbers; 
  GeoInpRecordset_ptr m_DB_tubes; 
  GeoInpRecordset_ptr m_DB_pcons;
  GeoInpRecordset_ptr m_DB_emecExtraCyl;
};
