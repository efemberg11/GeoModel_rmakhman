...
ENDIF()
IF ( DEFINED GEOMODEL_IO_DEEP_DEBUG )
  message( STATUS "You asked to print verbose debug information... (`-DGEOMODEL_IO_DEEP_DEBUG=${GEOMODEL_IO_DEEP_DEBUG}`)")
  ADD_DEFINITIONS(-DGEOMODEL_IO_DEEP_DEBUG)
ENDIF()
